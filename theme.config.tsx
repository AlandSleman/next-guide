  ...
  head: function useHead() {
    ...
    return (
      <>
        ...
        <meta name="apple-mobile-web-app-title" content="Next.js Guide" />
  ...
  footer: {
    text: (
      <div className="flex w-full flex-col items-center sm:items-start">
        <p>Next.js 13 Guide, Powered by <a target="_blank" style={{ textDecoration: "underline" }} href='https://nextra.site/'>Nextra</a></p>
